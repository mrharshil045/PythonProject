...
class Customer:
    ...
    def plot_balance(self, receiver, amount, stage):
        ...
        balances_before = [self.balance + amount, receiver.balance - amount] if stage == "Before Transfer" else [self.balance, receiver.balance]
        
        plt.figure(figsize=(6, 4))
        plt.bar(names, balances_before, color=['blue', 'green'])
